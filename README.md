...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://it)https://github.com/Vickyser/Sophia
     </div>
<br>
<br >
...
```js
SETUP
$ git clone https://github.com/Vickyser/Sophia-Mwol
$ cd Sophia-Mwol
$ chmod +x *
$ npm install @adiwajshing/baileys
$ node qr.js
